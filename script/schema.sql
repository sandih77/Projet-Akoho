...
CREATE TABLE Lot (id INT IDENTITY(1, 1) PRIMARY KEY,name VARCHAR(100) NOT NULL,race_id INT NOT NULL,date_achat DATE NOT NULL,nombre_akoho INT NOT NULL,age INT,prix_achat DECIMAL(10, 2),poids_initial DECIMAL(10, 2), CONSTRAINT FK_Lot_Race FOREIGN KEY (race_id) REFERENCES Race(id));
